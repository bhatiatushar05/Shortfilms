-- Simple Fix for Progress Table - No auth.uid() dependency
...
-- Create the update_progress function (simplified version)
...
-- Test with a simple insert (no function call)
SELECT 'Testing direct table insert...' as info;
INSERT INTO public.progress (user_id, title_id, position_sec, duration_sec) 
VALUES (
...
SELECT 'Progress table is now ready for use.' as info;
