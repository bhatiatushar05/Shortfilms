-- Fully Compatible Database Schema for Admin Portal
...
-- Create media table for file management (compatible with existing structure)
CREATE TABLE IF NOT EXISTS public.media (
    id TEXT PRIMARY KEY,
    title_id TEXT NOT NULL, -- No foreign key constraint initially
    episode_id TEXT, -- No foreign key constraint initially
...
-- Add foreign key constraints AFTER table creation (optional, for data integrity)
-- Uncomment these lines AFTER you've verified the tables work correctly

-- ALTER TABLE public.media ADD CONSTRAINT media_title_id_fkey 
--     FOREIGN KEY (title_id) REFERENCES public.titles(id) ON DELETE CASCADE;

-- ALTER TABLE public.media ADD CONSTRAINT media_episode_id_fkey 
--     FOREIGN KEY (episode_id) REFERENCES public.episodes(id) ON DELETE CASCADE;

-- ALTER TABLE public.content_approvals ADD CONSTRAINT content_approvals_title_id_fkey 
--     FOREIGN KEY (title_id) REFERENCES public.titles(id) ON DELETE CASCADE;
